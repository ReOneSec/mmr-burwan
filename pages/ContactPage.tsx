...
const ContactPage: React.FC = () => {
    ...
    return (
        <>
            <SEO
                title="Contact Us | MMR Burwan | Muslim Marriage Registration Office Murshidabad"
                description="Contact MMRBURWAN & QAAZI for Muslim marriage registration, nikah registration in Murshidabad. Office: Gramshalika, Burwan. Phone: 9732688698, 9647724532. Email: mmrburwan@gmail.com. Serving 21 blocks of Murshidabad district."
                keywords="MMR Burwan contact, Muslim marriage registration office, nikah registration office Murshidabad, marriage registrar near me, qazi office near me, MMR office Burwan, Muslim marriage registration help, nikah registration consultant, marriage registration service Murshidabad, authorized qazi West Bengal, government qazi registration"
                url="https://mmrburwan.com/contact"
            />
