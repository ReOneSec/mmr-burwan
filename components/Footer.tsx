      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-10 lg:mb-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-600">
              <li>{t('footer.helpline')}: <span className="text-gray-900 font-medium">9732688698, 9647724532</span></li>
              <li>Email: <span className="text-gray-900 font-medium">mmrburwan@gmail.com</span></li>
