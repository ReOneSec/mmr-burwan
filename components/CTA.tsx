  ...
  return (
    <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-gradient-to-b from-white to-rose-50 text-center">
      <div className="max-w-3xl mx-auto">
        <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 mb-4 sm:mb-6 px-2">Ready to register your marriage?</h2>
        <p className="text-sm sm:text-base lg:text-lg text-gray-600 mb-8 sm:mb-10 px-2">Join thousands of couples who have simplified their official paperwork with MMR Burwan.</p>
